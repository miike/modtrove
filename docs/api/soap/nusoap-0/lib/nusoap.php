...
// necessary classes
require_once('class.nu_soap_client.php');
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (nu_soap_client->response has contents of the response)");
			return false;
		}
...
/**
*
* nu_soap_client higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $nu_soap_client = new nu_soap_client( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $nu_soap_client->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($nu_soap_client);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.94 2005/08/04 01:27:42 snichol Exp $
* @access   public
*/
class nu_soap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function nu_soap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends nu_soap_client {
	'.$evalStr.'
}';
		return $evalStr;
	}
